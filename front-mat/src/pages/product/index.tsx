...
import TableProductHeader from 'src/components/product/TableProductHeader'
...
const ProductList = () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          <TableProductHeader value={value} handleFilter={handleFilter} toggle={toggleAddProductDrawer} />
          <DataGrid
            autoHeight
            rows={store.data}
            columns={columns}
